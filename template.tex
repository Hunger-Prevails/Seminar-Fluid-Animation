...
As explained in the last chapter, apart from substantially larger number of time steps, conventional approaches of globally fixed or adaptive time steps introduce several synchronization barriers within one iteration of the simulation. An illustration of this downside is given in \ref{fig3}. To mitigate the problem of wasted computational effort in previous works, the author proposes to assign to each individual particle a dedicated time step determined by eq. \ref{equa:7} and avoid any global synchronization barriers. 
