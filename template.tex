...
To mitigate the problem of wasted computational effort in previous works, The author proposes to determine a dedicated time step for each individual particle and avoid any global synchronizing 
