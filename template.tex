...
\begin{equation}
	\label{eq3}
	\boldsymbol{v}_{i}^{*} = \boldsymbol{v}_{i}(t) + \delta t\frac{\boldsymbol{F}_{i}^{advection}}{m_{i}}.
\end{equation}
...
\begin{split}
	\label{eq6}
	\boldsymbol{v}_{i}(t + \delta t) &= \boldsymbol{v}_{i}(t) + \delta t\frac{\boldsymbol{F}_{i}^{pressure}(t)}{m_{i}} \\
	\boldsymbol{x}_{i}(t + \delta t) &= \boldsymbol{x}_{i}(t) + \delta t \boldsymbol{v}_{i}(t + \delta t) + \frac{\delta t^{2}}{2}\frac{\boldsymbol{F}_{i}^{pressure}(t)}{m_{i}}.
\end{split}
\end{equation}
