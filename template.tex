...
\begin{figure}[tb]
	\centering
	\includegraphics[scale=0.24]{images/3}
...
\begin{figure}[tb]
	...
	\caption{\label{fig7} Visual comparison on the magnitude of particle velocities \cite{reinhardt2017fully}. Only negligible difference could be identified in the flow pattern behind the collision object.}
\end{figure}
